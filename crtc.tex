...
Without exception it seems that htotal can be set up 18 hdots before the
...
frame, the address will not be reset to zero at the beginning of the next
frame. This causes the address to keep cycling through VRAM even as we go from
frame to frame, resulting in a kind of scrolling effect.
...
Precisely when this happens hasn't been determined.
